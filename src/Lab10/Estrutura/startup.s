...
do_irq_interrupt: @Rotina de interrupções IRQ
	...
	ldmfd r0!, {r1}		@ guarda em linhaA r0

	LDMFD sp!, {r1}		@ recupera r1
	ldmfd r0!, {r1-12}	@ guarda em linhaA todos os registradores de proposito geral
	
	mov r2, lr			@ salva lr
	sub lr, lr, #4			@ tira 4 para acertar o lr
	ldmfd r0!, {sp, lr, pc, cpsr}	@ guarda os registradores banked
